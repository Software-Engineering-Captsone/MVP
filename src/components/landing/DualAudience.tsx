        ...
        <section className="dual-section" id="athletes">
            ...
            <div className="dual-grid">
                <div className="dual-card dual-card-light fade-up">
                    ...
                    <Link href="/auth?mode=signup" className="btn-pill btn-dark">Try as an athlete <span className="btn-dual-arrow">→</span></Link>
                </div>
                <div className="dual-card dual-card-dark fade-up" id="brands">
                    ...
                    <Link href="/auth?mode=signup" className="btn-pill btn-nilink-primary">Try as a brand <span className="btn-dual-arrow">→</span></Link>
                </div>
            </div>
        </section>
    );
