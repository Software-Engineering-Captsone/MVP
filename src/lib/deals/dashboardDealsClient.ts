...
const MOCK_ATHLETE_DEALS: ApiDeal[] = [
  {
    ...
    termsSnapshot: {
      ...
      frozen: {
        ...
        deliverables: [{ title: 'IG Reel + Story Set', type: 'instagram_post', instructions: 'Energy routine content', dueAt: daysFromNow(5), revisionLimit: 1, draftRequired: true }],
      },
    },
    status: 'active',
  ...
  },
  {
    ...
    termsSnapshot: {
      ...
      frozen: {
        ...
        deliverables: [{ title: 'Lookbook Post', type: 'instagram_post', instructions: 'Spring collection feature', dueAt: daysFromNow(10), revisionLimit: 2, draftRequired: true }],
      },
    },
    status: 'under_review',
  ...
  },
  {
    ...
    termsSnapshot: {
      ...
      frozen: {
        ...
        deliverables: [{ title: 'Launch Event Appearance', type: 'appearance_event', instructions: 'In-person appearance + recap post', dueAt: daysAgo(7), revisionLimit: 0, draftRequired: false }],
      },
    },
    status: 'paid',
