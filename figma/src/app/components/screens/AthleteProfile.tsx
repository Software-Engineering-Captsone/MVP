import { Instagram, Award, TrendingUp, Calendar, MapPin, Users, BarChart3, Heart, MessageCircle, Eye } from "lucide-react";
...
export function AthleteProfile() {
  ...
  const athlete = {
    ...
    bannerImage: "https://images.unsplash.com/photo-1767016697775-001518392206?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYXNrZXRiYWxsJTIwY291cnQlMjBhY3Rpb24lMjBhcmVuYXxlbnwxfHx8fDE3NzE4MTk4MTJ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    profileImage: "https://images.unsplash.com/photo-1590156552211-69280532a54a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhdGhsZXRpYyUyMG1hbGUlMjBiYXNrZXRiYWxsJTIwcGxheWVyJTIwcG9ydHJhaXR8ZW58MXx8fHwxNzcxODE5ODE0fDA&ixlib=rb-4.1.0&q=80&w=1080",
    socialStats: {
      instagram: {
    ...
    achievements: [
      "2x All-Conference Selection (2024, 2025)",
      "Team Captain - 2025 Season",
      "Academic All-American - 3.8 GPA",
      "Conference Rookie of the Year - 2024",
      "Led team in assists (6.2 APG) - 2025",
      "Community Leadership Award - 2025",
    ],
  };
      ...
      <div className="max-w-6xl mx-auto px-8 -mt-32 relative z-10">
        <div className="flex items-end gap-8 mb-8">
          ...
          <div className="relative">
            ...
            {isOpenToDeals && (
              <div
                className="absolute -bottom-3 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full font-bold text-xs shadow-lg whitespace-nowrap"
          ...
          <div className="flex-1 pb-4">
            ...
            <div className="flex items-center gap-6 text-lg text-gray-700 mb-4">
              <span className="flex items-center gap-2">
                <span className="font-bold" style={{ color: "#6CC3DA" }}>
                  {athlete.position}
                </span>
                • {athlete.sport}
              </span>
            ...
            <div className="inline-flex items-center gap-3 bg-white border-2 border-[#6CC3DA] rounded-xl px-6 py-3 shadow-sm">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                >
        ...
        <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <Users className="w-4 h-4" style={{ color: "#6CC3DA" }} />
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.instagram.followers}
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <BarChart3 className="w-4 h-4" style={{ color: "#6CC3DA" }} />
                    <p className="text-xs text-gray-500 uppercase">Posts/Mo</p>
                  </div>
                  <p
                    className="text-3xl font-bold"
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.instagram.postsPerMonth}
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <Heart className="w-4 h-4" style={{ color: "#6CC3DA" }} />
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.instagram.engagementRate}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.tiktok.followers}
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.tiktok.postsPerMonth}
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
                  >
                    {athlete.socialStats.tiktok.engagementRate}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-4 gap-4 mt-6">
            <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
              <p className="text-xs text-gray-500 uppercase mb-2">Total Reach</p>
              <p
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
              <p className="text-xs text-gray-500 uppercase mb-2">Avg. Engagement</p>
              <p
                className="text-2xl font-bold"
                style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
              >
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
              <p className="text-xs text-gray-500 uppercase mb-2">Monthly Posts</p>
              <p
                className="text-2xl font-bold"
                style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
              >
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 text-center shadow-sm">
              <p className="text-xs text-gray-500 uppercase mb-2">Est. Impressions</p>
              <p
                className="text-2xl font-bold"
                style={{ fontFamily: "'Barlow Condensed', sans-serif", color: "#6CC3DA" }}
              >
        ...
        {/* Availability Toggle (For Athlete's View) */}
        <div className="mb-12 bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h3
                className="text-2xl mb-2 tracking-tight text-gray-900"
                style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700 }}
              >
                DEAL AVAILABILITY
              </h3>
              <p className="text-gray-600">
                Let businesses know you're currently accepting new sponsorship opportunities
              </p>
            </div>
