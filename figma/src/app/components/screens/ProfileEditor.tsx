  ...
  return (
    <div className="p-8 w-full bg-white">
      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h2
          className="text-2xl mb-4 tracking-tight text-gray-900"
          style={{ fontFamily: "'Bebas Neue', sans-serif" }}
        >
          PROFILE PHOTO
        </h2>
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full bg-[#6CC3DA] flex items-center justify-center text-white text-3xl font-bold">
            MJ
          </div>
          <button
      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h2
          className="text-2xl mb-6 tracking-tight text-gray-900"
          style={{ fontFamily: "'Bebas Neue', sans-serif" }}
        >
          BASIC INFORMATION
        </h2>
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#6CC3DA] transition-colors text-gray-900"
            />
          </div>
          <div>
      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <textarea
          ...
          onChange={handleChange}
          rows={4}
          className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#6CC3DA] transition-colors resize-none text-gray-900"
          placeholder="Tell businesses about yourself, your values, and what you bring to sponsorships..."
        />
      </div>
      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#6CC3DA] transition-colors resize-none text-gray-900"
          placeholder="List your athletic achievements, awards, honors, academic accomplishments..."
        />
      </div>
      ...
      <div className="flex justify-end">
        <button
          className="flex items-center gap-2 px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-opacity"
          style={{ backgroundColor: "#6CC3DA", color: "#ffffff" }}
        >
