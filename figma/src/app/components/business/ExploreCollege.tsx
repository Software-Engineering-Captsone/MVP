...
import { Search, MapPin, Users, GraduationCap, TrendingUp } from "lucide-react";
...
export function ExploreCollege() {
  ...
  const handleCollegeClick = (college: College) => {
    navigate(`/business/college/${college.id}`, { state: { college } });
  };
      ...
      <div className="bg-white border-b border-gray-200 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Discover athletes by searching colleges and universities
          </p>
          ...
          <div className="grid grid-cols-5 gap-4">
            {filteredColleges.map((college) => (
              ...
              >
                ...
                {/* College Name */}
                <h3
                  className="text-base font-bold mb-1 text-gray-900 line-clamp-2"
                ...
                <div className="pt-3 border-t border-gray-100 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold" style={{ color: "#6CC3DA" }}>
                      {college.athleteCount}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <TrendingUp className="w-3 h-3 text-gray-400" />
                      <span className="text-xs text-gray-500">Avg. Eng.</span>
                    </div>
                    <span className="text-xs font-bold" style={{ color: "#6CC3DA" }}>
                      {college.avgEngagement}%
                    </span>
                  </div>
                </div>
