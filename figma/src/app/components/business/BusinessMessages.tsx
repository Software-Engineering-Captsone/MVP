  ...
  const conversations: Conversation[] = [
    {
      ...
      sport: "Basketball",
      lastMessage: "Sounds great! I'll have the content ready by Friday.",
      ...
      messages: [
        {
          id: 1,
          text: "Hi Marcus! Thanks for accepting our partnership proposal.",
          sender: "business",
          timestamp: "10:30 AM",
          read: true,
        },
        {
          id: 2,
          text: "Happy to work with you! What are the next steps?",
          sender: "athlete",
          timestamp: "10:35 AM",
          read: true,
        },
        {
          id: 3,
          text: "We'd like to schedule the first content shoot for this Friday. Does that work for you?",
          sender: "business",
          timestamp: "10:40 AM",
          read: true,
        },
        {
          id: 4,
          text: "Sounds great! I'll have the content ready by Friday.",
          sender: "athlete",
          timestamp: "10:42 AM",
          read: true,
        },
    ...
    },
    {
      ...
      sport: "Soccer",
      lastMessage: "I can do Tuesday at 2 PM",
      ...
      messages: [
        {
          id: 1,
          text: "Hi Sarah, we'd love to discuss a potential partnership.",
          sender: "business",
          timestamp: "Yesterday",
          read: true,
        },
        {
          id: 2,
          text: "I'm interested! When can we talk?",
          sender: "athlete",
          timestamp: "Yesterday",
          read: true,
        },
    ...
    },
    {
      ...
      messages: [
        {
          id: 1,
          text: "Hi Tyler! We're impressed with your engagement rates.",
          sender: "business",
          timestamp: "11:00 AM",
          read: true,
        },
    ...
    },
    {
      ...
      sport: "Volleyball",
      lastMessage: "I'd love to hear more details",
      ...
      messages: [
        {
          id: 1,
          text: "Hi Emily, we have a volleyball campaign that might interest you.",
          sender: "business",
          timestamp: "8:00 AM",
          read: true,
        },
        {
          id: 2,
          text: "I'd love to hear more details",
          sender: "athlete",
          timestamp: "8:45 AM",
          read: true,
        },
    ...
    },
    {
      ...
      messages: [
        {
          id: 1,
          text: "We're launching a fitness campaign next month.",
          sender: "business",
          timestamp: "Yesterday",
          read: true,
        },
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="relative flex-shrink-0">
                  <img
                    src={conv.athleteImage}
                    alt={conv.athleteName}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white border-b border-gray-200 p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="relative">
                <img
                  src={activeConversation.athleteImage}
                  alt={activeConversation.athleteName}
                  className="w-12 h-12 rounded-full object-cover"
                />
              ...
              <div>
                ...
                >
                  {activeConversation.athleteName.toUpperCase()}
                </h2>
                <p className="text-sm text-gray-600">
                  {activeConversation.sport} • {activeConversation.online ? "Online" : "Offline"}
                </p>
              </div>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-end gap-1 mt-1">
                    ...
                    {message.sender === "business" && (
                      <CheckCheck
                        className={`w-4 h-4 ${message.read ? "text-blue-100" : "text-blue-200"}`}
                      />
                    )}
                  </div>
                </div>
