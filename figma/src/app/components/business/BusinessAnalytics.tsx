...
export function BusinessAnalytics() {
  ...
  const sportDistribution = [
    { sport: "Basketball", athletes: 8, value: 28 },
    { sport: "Football", athletes: 6, value: 21 },
    { sport: "Soccer", athletes: 5, value: 18 },
    { sport: "Track & Field", athletes: 12, value: 17 },
    { sport: "Volleyball", athletes: 4, value: 9 },
    { sport: "Other", athletes: 3, value: 7 },
  ];
      ...
      <div className="bg-white border-b border-gray-200 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-700 mb-2 font-bold">Campaign</label>
              <select
              ...
              >
                ...
                <option value="1">Spring Training Fuel Campaign</option>
                <option value="2">Basketball Season Sponsorship</option>
                <option value="3">Track & Field Partnership</option>
              </select>
            </div>
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-700 mb-2 font-bold">Sport</label>
              <select
                value={selectedSport}
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <p className="text-sm text-gray-600 mb-2 font-bold">Total Reach</p>
              <div className="flex items-center justify-between">
                <p className="text-3xl font-bold text-black">
                  1.21M
                </p>
                <div className="px-3 py-2 rounded-lg bg-green-100">
                  <span className="text-base font-bold text-green-600">+12.5%</span>
                </div>
              </div>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <p className="text-sm text-gray-600 mb-2 font-bold">Avg. Engagement</p>
              <div className="flex items-center justify-between">
                <p className="text-3xl font-bold text-black">
                  9.2%
                </p>
                <div className="px-3 py-2 rounded-lg bg-green-100">
                  <span className="text-base font-bold text-green-600">+8.3%</span>
                </div>
              </div>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <p className="text-sm text-gray-600 mb-2 font-bold">Total ROI</p>
              <div className="flex items-center justify-between">
                <p className="text-3xl font-bold text-black">
                  3.6x
                </p>
                <div className="px-3 py-2 rounded-lg bg-green-100">
                  <span className="text-base font-bold text-green-600">+15.7%</span>
                </div>
              </div>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <p className="text-sm text-gray-600 mb-2 font-bold">Active Athletes</p>
              <div className="flex items-center justify-between">
                <p className="text-3xl font-bold text-black">
                  38
                </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <h3
                className="text-2xl mb-4 tracking-tight text-black"
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <h3
              className="text-2xl mb-6 tracking-tight text-black"
              style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700 }}
            >
              AUDIENCE DEMOGRAPHICS
            </h3>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium text-black">Marcus Johnson</td>
                    <td className="py-3 px-4 text-black">Basketball</td>
                    <td className="py-3 px-4 text-right font-bold text-black">37.9K</td>
                    <td className="py-3 px-4 text-right font-bold text-black">8.5%</td>
                    <td className="py-3 px-4 text-right font-bold text-black">4.2x</td>
                  </tr>
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium text-black">Sarah Chen</td>
                    <td className="py-3 px-4 text-black">Soccer</td>
                    <td className="py-3 px-4 text-right font-bold text-black">28.5K</td>
                    <td className="py-3 px-4 text-right font-bold text-black">9.2%</td>
                    <td className="py-3 px-4 text-right font-bold text-black">3.8x</td>
                  </tr>
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium text-black">Aisha Patel</td>
                    <td className="py-3 px-4 text-black">Tennis</td>
                    <td className="py-3 px-4 text-right font-bold text-black">32.1K</td>
                    <td className="py-3 px-4 text-right font-bold text-black">8.8%</td>
                    <td className="py-3 px-4 text-right font-bold text-black">3.5x</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium text-black">Tyler Washington</td>
                    <td className="py-3 px-4 text-black">Football</td>
                    <td className="py-3 px-4 text-right font-bold text-black">45.2K</td>
                    <td className="py-3 px-4 text-right font-bold text-black">7.8%</td>
                    <td className="py-3 px-4 text-right font-bold text-black">3.2x</td>
                  </tr>
                </tbody>
              </table>
            </div>
