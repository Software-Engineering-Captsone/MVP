-- Align campaign/application status checks with the lifecycle used by the app.
-- Existing projects may still have older functions or constraints that reject
-- Active campaigns or offer_drafted/offer_sent/offer_declined applications.
